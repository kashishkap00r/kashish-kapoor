...
We build a simple spending plan, budgeting that doesn’t suck, and automations.

### 3) Insurance + emergency planning
This is the “don’t get wiped out” pillar.  
Emergency fund + the right insurances, based on your life (not generic advice).

### 4) Debt management
Existing loans or future loans — both matter.  
...
- you want trading calls / stock tips
- you want guarantees

---

## Quick note (compliance, in plain English)

This is **not investment advisory**. I’m **not SEBI registered**.  
I’m not a stock tips service, not an MFD, and I don’t sell financial products.

This is 1:1 help to bring structure and clarity to your personal finances — **you make the final calls**.
